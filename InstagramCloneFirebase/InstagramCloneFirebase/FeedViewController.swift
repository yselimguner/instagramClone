...
class FeedViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var documentIdArray = [String]() //Burası like için
    ...
    //Gerçek zamanlı veri çekmek için yazdığımız kod.
        ...
        fireStoreDatabase.collection("Posts").order(by: "date", descending: true)
            ...
            if error != nil {
                ...
                if snapshot?.isEmpty != true && snapshot != nil {
                    ...
                    self.documentIdArray.removeAll(keepingCapacity: false) //Burası like için
                    
                    for document in snapshot!.documents {
                        let documentID = document.documentID
                        
                        self.documentIdArray.append(documentID) //Burası like için
